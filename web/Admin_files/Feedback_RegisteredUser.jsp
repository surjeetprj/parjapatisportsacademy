...
<html>
    ...
    <body>
        ...
        <div  class="container mt-4">
            <h3 class="text-center" style=" color:red;text-decoration-color: black; text-decoration-line:underline; font-family: face-arial;">Registered User Feedbacks</h3>
            <table class="table table-striped text-center">
                ...
                <%  
                    ...
                    feedList = feedbackDao.GetFeedback(start,recordCount);
                    // GET TOTAL NUMBER OF RECORDS
                     int total = feedbackDao.TotalRecords();
                   ...
                   <div class="container" style="display: flex; justify-content: flex-end;">
                            ...
                            <div style=" color: white; margin-right: 2rem;"><a href="Feedback_RegisteredUser.jsp?pgNo=<%=pgNO-1%>" class="btn btn-dark <%= (start==0)?"disabled":""%> ">Previous</a></div>
                            <div style="  color: white"><a href="Feedback_RegisteredUser.jsp?pgNo=<%=pgNO+1%>" class="btn btn-dark <%= (start+recordCount>=total)?"disabled":" " %> ">Next</a></div>
                    </div>
        </div>
        </div>
    </body>
