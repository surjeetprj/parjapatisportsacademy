...
<html>
    <head>
        ...
        <title>Outdoor Games Schedule</title>
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <body>
        ...
        <div id="show-course" class="container">
            <div>
                <h3 class="text-center" style=" color:red;text-decoration-color: greenyellow; text-decoration-line:underline;font-family: face-arial">Outdoor Games Schedule</h3>
                <table class="table table-striped text-center"> 
                    <%   //getting Indoot Game schedule form data base.
                        ...
                        scheduleList = scheduleDao.GetSchedule("Outdoor Games");
                    ...
                    <tr>
                        ...
                        <td><%= s.getDays()%></td>
                        <td><%= s.getTiming()%></td>
                        <td><a href="Update_Schedule.jsp?c-id=<%=s.getcId()%>&c-category=Outdoor Games" class="btn btn-success text-white" >Update</a></td>
                    </tr>
                    <%}%>
                </table>
            </div>
        ...
        <!--<--- Add New Schedule ---->
        <div id="add-course"class="container mt-3 mb-4" style="width: 80vh; display:none; padding: 5px; border:blue 2px solid; border-radius: 5px; ">
